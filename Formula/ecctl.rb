...
class Ecctl < Formula
  ...
  if OS.mac?
    url "https://github.com/elastic/ecctl/releases/download/1.0.0-rc1/ecctl_1.0.0-rc1_darwin_amd64.tar.gz", :using => EcctlDownloadStrategy
    sha256 "ba8ba035995100f396d5e6de017909a782edf60ef3a1a0783b14976ad1c582c0"
  elsif OS.linux?
    url "https://github.com/elastic/ecctl/releases/download/1.0.0-rc1/ecctl_1.0.0-rc1_linux_amd64.tar.gz", :using => EcctlDownloadStrategy
